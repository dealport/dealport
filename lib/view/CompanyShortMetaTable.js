...
CompanyShortMetaTable.prototype.getValues = function()
{
        return {
                revenueModel: this.revenueModel.value,
                hiring: this.hiring.value,
                openForInvestment:  this.openForInvestment.value
        };
};
