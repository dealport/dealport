...
function CompanyShortMetaTable(node, router, company)
{
        ...
        if (this.isCreationConstructor(node))
        {
                ...
                {
                        this.addRow('hiring', 'Hiring', company.hiring ? 'Yes' : 'No')
                                .cls(company.hiring ? 'yes' : 'no');
                }

                this.addRow('openForInvestment', 'Open for investment', company.openForInvestment ? 'Yes' : 'No')
                        .cls(company.openForInvestment ? 'yes' : 'no');
        }
        else
        {
