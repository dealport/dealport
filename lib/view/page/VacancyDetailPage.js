...
function VacancyDetailPage(node, router, company, vacancy)
{
                        ...
                        div('header',
                                ...
                                h2('title',
                                        ...
                                        this.companyLink = new NamedEntityAnchor(
                                                ...
                                                company,
                                                'none',
                                                this.companyTitle = new EditablePlainText(
                                                        this.document,
                                                        'span',
                                                        false,
                                                        company.name + ''
        ...
        else
        {
                ...
                this.logoLink = this.assertSelector('> .header > .logo', NamedEntityAnchor, router);
                ...
                this.companyLink = this.assertSelector('> .header .title > .companyLink', NamedEntityAnchor, router);
...
VacancyDetailPage.prototype.attachEditingContexts = P.method(function(contextFactory)
{
        ...
        return P.join(
                this.logoLink.attachContext(companyContextFactory),
                this.logo.attachEditingContext('logoUploadedImage', companyContextFactory),
                this.companyLink.attachContext(companyContextFactory),
                this.companyTitle.attachEditingContext('name', companyContextFactory),
