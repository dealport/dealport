...
function CompanyDetailPage(node, router, company, vacancies)
{
        ...
        else
        {
                ...
                this.header = this.assertSelector('> .left > .CompanyHeader', CompanyHeader, router);
                ...
                this.vacancies = this.assertSelector('> .right > .CompanyVacancyList', CompanyVacancyList, router);
