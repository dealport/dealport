...
function StateAnchor(node, urlStateMap, state, content)
{
        var i;
        ...
        if (!urlStateMap)
        {
                throw new domv.Exception(Error('new StateAnchor : urlStateMap argument is required'));
        }
...
Object.defineProperty(StateAnchor.prototype, 'state', {
        get: function()
        {
                return this.urlStateMap.parse(this.getAttr('href'));
        },
        set: function(value)
        {
                var url;
                ...
                if (value)
                {
                        url = this.urlStateMap.stringify(value);
