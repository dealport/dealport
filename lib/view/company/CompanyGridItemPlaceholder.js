...
function CompanyGridItemPlaceholder(node, urlStateMap)
{
        ...
        if (this.isCreationConstructor(node))
        {
                ...
                this.appendChild(this.anchor = new StateAnchor(this.document, urlStateMap, ['page', 'home', 'submit'],
        ...
        else
        {
                ...
                this.anchor = this.assertSelector('> .StateAnchor', StateAnchor, urlStateMap);
        }
}
