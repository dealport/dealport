...
function CompanyHeader(node, router, company, extended)
{
...
CompanyHeader.prototype.attachEditingContexts = P.method(function(contextFactory)
{
        ...
        return P.join(
                ...
                this.meta && this.meta.attachEditingContexts(contextFactory),
                this.sectors && this.sectors.attachEditingContext('sectors', contextFactory)
        );
});