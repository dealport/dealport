...
function RemoveConfirmation(node, router, what, cancelState)
{
        ...
        if (this.isCreationConstructor(node))
        {
                ...
                this.appendChild(
                        ...
                        div('buttons',
                                ...
                                this.cancelButton = new StateAnchor(this.document, router, cancelState, 'Cancel').cls('cancel')
                        )
                );
        }
        else
        {
                ...
                this.cancelButton = this.assertSelector('> .buttons > .cancel', StateAnchor, router);
        }
