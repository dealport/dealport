...
CompanyContactInfo.prototype.setValues = function(company)
{
        this.table.setValues(company);
};

CompanyContactInfo.prototype.getValues = function(since)
{
        return this.table.getValues(since);
};
