...
function SubmitForm(node, urlStateMap, csrfToken, showSubmitterFields)
{
        ...
        else
        {
                ...
                this.thanksAnchor = this.selector('> .thanks > .StateAnchor', StateAnchor, this.urlStateMap);
        }
...
SubmitForm.prototype.showThanks = function(goBackState)
{
        ...
        this.appendChild(div('thanks',
                ...
                this.thanksAnchor = new StateAnchor(this.document, this.urlStateMap, goBackState, '[close]')
