...
function SubmitForm(node, router, csrfToken)
{
        ...
        this.lazyValidate = swissarmyknife.lazyTimeout(100, this.validate.bind(this, false));
        this.on('submit', this._onSubmit.bind(this));
        this.addDomListener('change', this.lazyValidate, true);
