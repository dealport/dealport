...
function BaseDocument(node, router)
{
        ...
        if (this.isCreationConstructor(node))
        {
                ...
                this.appendChild(
                        ...
                        this.header = div('header',
                                div('wrap',
                                        this.userName = div('userName', {style: 'display: none'}),
        ...
        else
        {
                ...
                this.userName = this.header.assertSelector('> .wrap > .userName');
                this.loginAnchor = this.header.assertSelector('> .wrap > .loginAnchor', StateAnchor, router);
                this.headerTitle = this.header.assertSelector('> .wrap > .title');
...
{
        this.loginAnchor.style.display = user ? 'none' : 'block';
        this.userName.style.display = user ? 'block' : 'none';
