...
Object.defineProperty(EditableDropDown.prototype, 'open', {
        ...
        set: function(value)
        {
                ...
                if (value && !this.popup)
                {
                        ...
                        this.popup.on('domv-popup-outside-mousedown', this._onPopupOutsideMousedown, false, this);
                        this.popup.on('domv-popup-outside-focus', this._onPopupOutsideFocus, false, this);
...
EditableDropDown.prototype._focusFirstItem = function()
{
        var first = this.popup && this.popup.list.firstElementChild;
        if (first)
        {
                first.focus = true;
        }
...
EditableDropDown.prototype._onPopupOutsideMousedown = function(e)
{
        this.open = false;
};

EditableDropDown.prototype._onPopupOutsideFocus = function(e)
{
        this.open = false;
        this.focus = true;
};
...
EditableDropDown.prototype.attachEditingContext = P.method(function(path, contextManager)
{
        this._sharePath = null;
