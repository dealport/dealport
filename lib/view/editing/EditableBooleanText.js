...
EditableBooleanText.prototype._onClick = function(e)
{
        ...
        e.preventDefault();
        this._changedByUser(this.value, !this.value);
};
...
EditableBooleanText.prototype._changedByUser = function(oldValue, newValue)
{
        var eventData = {
...
EditableBooleanText.prototype.attachEditingContext = P.method(function(path, contextManager)
{
        this._sharePath = null;
...
EditableBooleanText.prototype.handleOperationComponent = function(comp)
{
        if ('oi' in comp)
        {
                this.value = comp.oi;
