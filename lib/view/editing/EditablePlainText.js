...
function EditablePlainText(node, options)
{
        if (!options) { options = {}; }
        domv.Component.call(this, node, options.tagName || 'div');
        ...
        this.on('focus', this._onFocus, true);
        this.on('blur', this._onBlur, true);
        this._showPlaceHolder = lazyTimer(1, false, this, this._showPlaceHolderImpl);
}
...
Object.defineProperty(EditablePlainText.prototype, 'placeholder', {
        configurable: true,
        get: function()
        {
                return this.getAttr('data-placeholder');
        },
        set: function(value)
        {
                ...
                {
                        this.attr('data-placeholder', value + '');
                }
        }
});
...
EditablePlainText.prototype._setValue = function(value)
{
...
Object.defineProperty(EditablePlainText.prototype, 'value', {
        ...
        get: function()
        {
                ...
                if (this.multiline)
                {
                        // (this does not work properly for things like <p>foo<br/>bar</p>,
...
EditablePlainText.prototype._onFocus = function(e)
{
        if (this.hasClass('placeholder'))
        {
                this._setValue('');
...
EditablePlainText.prototype._onBlur = function(e)
{
        this._showPlaceHolder();
};

EditablePlainText.prototype._showPlaceHolderImpl = function()
{
        if (this.placeholder &&
            !this.hasFocus &&
...
EditablePlainText.prototype.attachEditingContext = P.method(function(path, contextManager)
{
        this._sharePath = null;
...
EditablePlainText.prototype._contextOnOp = function(components)
{
...
EditablePlainText.prototype.handleOperationComponent = function(comp)
{
        if ('oi' in comp)
        {
                this.value = comp.oi;
...
EditablePlainText.prototype._submitOpImpl = function(done)
{
        if (this.hasClass('placeholder'))
        {
                return;
