...
function VacancyAnchor(node, router, company, vacancy, content)
{
...
VacancyAnchor.prototype._update = function()
{
        var namedVacancy = new this.router.NamedVacancy(
                this.getAttr('data-company-name'),
                this.getAttr('data-vacancy-name')
        );
        this.state = ['page', namedVacancy];
};

// used to update the href as needed
VacancyAnchor.prototype.attachContext = P.method(function(contextFactory)
{
        ...
        return P.join(
                contextFactory.get('company', this.getAttr('data-company-id')),
                contextFactory.get('vacancy', this.getAttr('data-vacancy-id'))
        )
        .bind(this)
