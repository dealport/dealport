        ...
        if (this.isCreationConstructor(node))
        {
                ...
                this.appendChild(
                        ...
                        this.desc = new EditablePlainText(this.document, {
                                ...
                                placeholder: 'A long description for the job vacancy\n\n' +
...
VacancyDescription.prototype.attachEditingContexts = P.method(function(contextManager)
{
        return P.join(
                this.desc.attachEditingContext('description', contextManager)
        );
});