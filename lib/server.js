...
function serverInitialize(config)
{
        ...
        app.use('/bundle.css', staticFile('generated-web/bundle.css.gz', {encoded: 'gzip'}));
        app.use('/bundle.css', staticFile('generated-web/bundle.css'));
        app.use('/bundle.js' , staticFile('generated-web/bundle.js.gz', {encoded: 'gzip'}));
        app.use('/bundle.js' , staticFile('generated-web/bundle.js'));
