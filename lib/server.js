...
var contextNewState = function(states)
{
        ...
        context._setLocation = context.urlStateMap.toURL(states);
        return P.resolve();
};
...
{
        var context = this;
        context._replaceLocation = context.urlStateMap.toURL(states);
};
...
function serverInitialize(config)
{
        ...
        app.use('/bundle.css', staticFile('generated-web/bundle.css.gz', {maxAge: '7d', encoded: 'gzip'}));
        app.use('/bundle.css', staticFile('generated-web/bundle.css'   , {maxAge: '7d'}));
        app.use('/bundle.js' , staticFile('generated-web/bundle.js.gz' , {maxAge: '7d', encoded: 'gzip'}));
        app.use('/bundle.js' , staticFile('generated-web/bundle.js'    , {maxAge: '7d'}));

        if (config.debugMode)
        {
                app.use('/bundle.css.map', staticFile('generated-web/bundle.css.map'));
        }
        ...
        app.use(function controllerRequest(req, res)
        {
                ...
                var states = context.urlStateMap.fromURL(req.url);
