...
function updateExternalProfile(model, providerName, profile)
{
        ...
        return model.acquire().then(function(client)
        {
...
module.exports = function(model, config, expressApp, primusServer)
{
        var passportInitialize = passport.initialize();
        var passportSession = passport.session();
        expressApp.use(passportInitialize);
        expressApp.use(passportSession);
        primusServer.before('passportInitialize', passportInitialize);
        primusServer.before('passportSession', passportSession);
