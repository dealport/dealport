...
function CompanyDetailPageController(context, pageView, company, acquireContextsResult)
{
...
CompanyDetailPageController.prototype.beforeEnter = function(state, upgrade)
{
        if (this.acquireContextsResult)
        {
                this.acquireContextsResult.addListener(this._onCompanyOp);
        }
};
...
CompanyDetailPageController.prototype.afterLeave = function()
{
        if (this.acquireContextsResult)
        {
                this.acquireContextsResult.removeListener(this._onCompanyOp);
        }
};
