...
PageController.prototype._setupNamedEntityOnOp = function(collection, id)
{
        if (!this._contextFactory)
        {
                return P.resolve();
        ...
        .then(function(context)
        {
                context._onOp = function(components)
                {
                        components.forEach(function(comp)
                        {
                                ...
                                var namedEntityState = new this.context.router.NamedEntity(namedEntityId || id);
...
PageController.prototype.enterNamedEntity = function(namedEntityState, upgrade)
{
        ...
        if (upgrade)
        {
                ...
                if (this.pageView)
                {
                        ...
                        .then(function(entity)
                        {
                                ...
                                return P.join(
                                        this._setupNamedEntityOnOp('company', this.pageView.id),
                ...
                if (this.pageView)
                {
                        ...
                        .then(function(entity)
                        {
                                ...
                                return P.join(
                                        this._setupNamedEntityOnOp('user', this.pageView.id),
                                        this.pageView.attachEditingContexts(this._contextFactory)
                                );
                        });
                }
        ...
        .spread(function(named, entity)
        {
                ...
                return P.join(
                        this._setupNamedEntityOnOp(collection, entity._id),
                        this.pageView.attachEditingContexts(this._contextFactory)
                );
        });
...
PageController.prototype.enterVacancy = function(namedVacancy, upgrade)
{
        ...
        .spread(function(named, company, vacancy)
        {
                ...
                return this.pageView.attachEditingContexts(this._contextFactory);
                // todo update url && doc title when vacancy title changes
        });
};