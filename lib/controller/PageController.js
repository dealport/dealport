...
{
        var NamedEntityState = this.context.urlStateMap.NamedEntity;
        var NamedVacancyState = this.context.urlStateMap.NamedVacancy;
...
{
        var Vacancy = this.context.resource.Vacancy;
        var NamedVacancy = this.context.urlStateMap.NamedVacancy;
        var Company = this.context.resource.Company;
        ...
        {
                var namedVacancy = new NamedVacancy(company.namedEntityId || company._id, vacancy._id);
