...
FrontController.prototype.enter404 = function(state, upgrade)
{
        if (upgrade)
        {
...
FrontController.prototype.enterLogin = function(state, upgrade)
{
        var doc = this.context.document;

        if (upgrade)
        {
                this.pageView = doc.assertSelector('> .LoginPage', LoginPage, this.context.urlStateMap);
                return;
        }

        this.pageView = new LoginPage(doc.document, this.context.urlStateMap);
