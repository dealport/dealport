...
function HomePageController(context, pageView, acquireContextsResult)
{
...
HomePageController.prototype._onStateSelectAddCompany = function(e)
{
        ...
        P.using(this.context.document.savePendingDisposer(), function()
        {
                ...
                return P.join(
                        this.state(['edit']),
                        Company.newEmptyCompany(this.acquireContextsResult),
...
HomePageController.prototype._handleSubmitFormSubmit = function(e)
{
        ...
        .then(function()
        {
                submitForm.showThanks(self.getFullStateList('none'));
        })
        .catch(ga.logException)
        .catch(function(err)
        {
