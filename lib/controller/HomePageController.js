...
HomePageController.prototype._onEditChangeImpl = function(done)
{
        ...
        var homePageCompanyContexts = this.parent.homePageCompanyContexts;
        ...
        P.using(this.context.document.savePendingDisposer(), function()
        {
                ...
                return P.map(items, function(item)
                {
                        ...
                        var context = homePageCompanyContexts.get(item.id);
                        if (!context)
                        {
                                console.warn('Unable to update company %s, the sharejs context is missing', item.id);
                        }
...
HomePageController.prototype._onStateSelectAddCompany = function(e)
{
        ...
        P.using(this.context.document.savePendingDisposer(), function()
        {
                ...
                return P.join(
                        this.state(['edit']),
                        Company.newEmptyCompany(this.parent.homePageCompanyContexts),
