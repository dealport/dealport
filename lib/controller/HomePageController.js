...
HomePageController.prototype._onEditChangeImpl = function(done)
{
        ...
        ++this.context.document.savingPending;
        ...
        P.map(items, function(item)
        {
                ...
                if (values)
                {
                        ...
                        return P.join(Company.updateCompany(item.id, values), logoPromise);
                }
        ...
        // todo savePending using a bluebird disposer
};
...
HomePageController.prototype._onStateSelectAddCompany = function(e)
{
        ...
        P.join(
                ...
                function(nothing, company) { return company; }
        ).bind(this)
