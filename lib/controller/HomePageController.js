...
HomePageController.prototype.enterEdit = function(state)
{
        ...
        this.parent.pageView.companyGrid.on('domv-editable-change', function()
        {

        });

        // todo lazy timeout to send results to the server
        // todo resource method to perform the saving
        // todo change events
};
