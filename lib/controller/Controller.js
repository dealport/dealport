...
/**
 * Return all the states this controller is part of.
 * This is identical to calling getRootController().getChildrenStateList()
 * @returns {ControllerStateList}
 */
Controller.prototype.getFullStateList = function()
{
        return this.getRootController().getChildrenStateList();
};

/**
 * Return all the states this controller is part of and replace the state for this controller.
 * @returns {ControllerStateList}
 */
Controller.prototype.getFullStateListAndReplace = function(state)
{
        var states = this.getParentsStateList();
        states[states.length - 1] = state;
...
Controller.Dummy = DummyController;
