 ...
 */
Company.prototype.ids = function(ids, contextManager)
{
        // (snapshots should not be modified)

        if (contextManager)
        {
                return contextManager.getSnapshot('company', ids);
        }
 ...
 * @returns {Promise<Object>} snapshots
 */
Company.prototype.all = function(contextManager)
{
        return this._all()
        .then(function(ids)
        {
 ...
 * @returns {Promise<Object>} snapshots
 */
Company.prototype.newEmptyCompany = function(contextManager)
{
        return this.rpc('newEmptyCompany')
        .then(function(id)
        {
                if (this._cache._all &&
                    this._cache._all.isFulfilled())
                {
...
{
        return this.rpc('removeCompany', companyId)
        .bind(this)
