...
var SharejsContextManager = require('../../model/SharejsContextManager');
...
module.exports = function(primus, sharejsConn)
{
        return {
                ...
                Vacancy: new (require('./Vacancy'))(primus, sharejsConn),

                createContextManager: function(defaultCollection, defaultId)
                {
                        return new SharejsContextManager(sharejsConn, defaultCollection, defaultId);
                }
        };
};
