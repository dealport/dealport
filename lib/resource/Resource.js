...
Resource.prototype.findChannel = function()
{
        ...
        var lowestPending = this.getChannelSparkData(bestChannel).pending;
        ...
        for (var i = 1; i < this.channelSparks.length; ++i)
        {
                ...
                if (channel &&
                    channelSparkData.pending < lowestPending)
                {
                        lowestPending = channelSparkData.pending;
                        bestChannel = channel;
                }
        }
