...
module.exports.lazyTimeout = function(millis, callback, thisObject, args)
{
        if (!thisObject)
        {
                thisObject = null;
        ...
        function lazyTimeoutInvoker()
        {
                if (lazyTimeoutInvoker._timeout)
                {
                        return;
                }

                lazyTimeoutInvoker._timeout = setTimeout(function()
                {
                        try
                        {
                        ...
                        {
                                lazyTimeoutInvoker._timeout = 0;
                        }
                }, millis);
        }

        return lazyTimeoutInvoker;
};
